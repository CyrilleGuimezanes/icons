...
/// <summary>
/// Builds the Potager (Production) screen UI at runtime.
/// </summary>
public class PotagerScreenBuilder : UIBuilderBase
{
    ...
    public override void BuildScreen()
    {
        ...
        // Create screen root
        screenRoot = CreateFullScreenPanel("PotagerScreen", transform, UIColors.Background);
    ...
    {
        productionController = screenRoot.AddComponent<ProductionController>();

        productionController.InitializeReferences(
            productionSlots,
            inventoryContainer,
            inventoryIconPrefab,
            multiplierX1Button,
    ...
    /// <summary>
    /// Gets the ProductionController component.
    /// </summary>
    public ProductionController GetController() => productionController;
}
