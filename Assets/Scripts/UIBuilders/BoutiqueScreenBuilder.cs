...
/// <summary>
/// Builds the Boutique (Shop) screen UI at runtime.
/// </summary>
public class BoutiqueScreenBuilder : UIBuilderBase
{
    ...
    public override void BuildScreen()
    {
        ...
        screenRoot = CreateFullScreenPanel("BoutiqueScreen", transform, UIColors.Background);
    ...
    {
        shopController = screenRoot.AddComponent<ShopController>();

        shopController.InitializeReferences(
            coinBalanceText,
            nextCoinTimerText,
            iconsTabButton,
            packsTabButton,
    ...
    public ShopController GetController() => shopController;
}
