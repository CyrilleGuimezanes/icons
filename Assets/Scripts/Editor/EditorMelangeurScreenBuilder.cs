...
/// <summary>
/// Editor script that builds the Mélangeur (Mixer) screen UI.
/// </summary>
public class EditorMelangeurScreenBuilder : EditorUIBuilderBase
{
    ...
    [MenuItem("Icons/Build UI/Screens/Build Melangeur Screen")]
    public static void BuildMelangeurScreen()
    {
        ...
        // Find or create screens container
        ...
        Transform existing = screensContainer.Find("MelangeurScreen");
        if (existing != null)
        {
            Undo.DestroyObjectImmediate(existing.gameObject);
        }

        EditorMelangeurScreenBuilder builder = new EditorMelangeurScreenBuilder();
        builder.BuildScreen(screensContainer);
        
        EditorSceneManager.MarkSceneDirty(EditorSceneManager.GetActiveScene());
        Debug.Log("Melangeur screen built successfully!");
    }
    ...
    public override void BuildScreen(Transform parent)
    {
        ...
        // Create screen root
        screenRoot = CreateFullScreenPanel("MelangeurScreen", parent, UIColors.Background);
    ...
    private MixerSlot CreateMixerSlot(Transform parent, int index)
    {
        ...
        Undo.RegisterCreatedObjectUndo(slotObj, $"Create MixerSlot_{index}");
    ...
    private void CreateInventoryIconPrefab()
    {
        ...
        Undo.RegisterCreatedObjectUndo(inventoryIconPrefab, "Create InventoryIconTemplate");
    ...
    {
        // Add MelangeurController
        MelangeurController controller = screenRoot.GetComponent<MelangeurController>();
        if (controller == null)
        {
            controller = screenRoot.AddComponent<MelangeurController>();
        }
