...
/// <summary>
/// Editor script that builds the Collection screen UI.
/// </summary>
public class EditorCollectionScreenBuilder : EditorUIBuilderBase
{
    // UI References
    ...
    [MenuItem("Icons/Build UI/Screens/Build Collection Screen")]
    public static void BuildCollectionScreen()
    {
        ...
        Transform existing = screensContainer.Find("CollectionScreen");
        if (existing != null)
        {
            Undo.DestroyObjectImmediate(existing.gameObject);
        }

        EditorCollectionScreenBuilder builder = new EditorCollectionScreenBuilder();
        builder.BuildScreen(screensContainer);
        
        EditorSceneManager.MarkSceneDirty(EditorSceneManager.GetActiveScene());
        Debug.Log("Collection screen built successfully!");
    }
    ...
    public override void BuildScreen(Transform parent)
    {
        ...
        screenRoot = CreateFullScreenPanel("CollectionScreen", parent, UIColors.Background);
    ...
    private void CreateCollectionIconPrefab()
    {
        ...
        collectionIconPrefab.transform.SetParent(screenRoot.transform, false);
        collectionIconPrefab.SetActive(false);
        Undo.RegisterCreatedObjectUndo(collectionIconPrefab, "Create CollectionIconTemplate");
    ...
    {
        CollectionController controller = screenRoot.GetComponent<CollectionController>();
        if (controller == null)
        {
            controller = screenRoot.AddComponent<CollectionController>();
        }
