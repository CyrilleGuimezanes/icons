...
/// <summary>
/// Editor script that builds the Options (Settings) screen UI.
/// </summary>
public class EditorOptionsScreenBuilder : EditorUIBuilderBase
{
    // UI References
    ...
    [MenuItem("Icons/Build UI/Screens/Build Options Screen")]
    public static void BuildOptionsScreen()
    {
        ...
        Transform existing = screensContainer.Find("OptionsScreen");
        if (existing != null)
        {
            Undo.DestroyObjectImmediate(existing.gameObject);
        }

        EditorOptionsScreenBuilder builder = new EditorOptionsScreenBuilder();
        builder.BuildScreen(screensContainer);
        
        EditorSceneManager.MarkSceneDirty(EditorSceneManager.GetActiveScene());
        Debug.Log("Options screen built successfully!");
    }
    ...
    public override void BuildScreen(Transform parent)
    {
        ...
        screenRoot = CreateFullScreenPanel("OptionsScreen", parent, UIColors.Background);
    ...
    {
        OptionsController controller = screenRoot.GetComponent<OptionsController>();
        if (controller == null)
        {
            controller = screenRoot.AddComponent<OptionsController>();
        }
